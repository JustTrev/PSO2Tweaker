...
#End If
    ...
    Private Sub btn_switchUI_Click(sender As Object, e As EventArgs) Handles btn_switchUI.Click
        'Automatically restart to open Tweaker in classic mode.
        MsgBox("Switched to Classic mode. You may now restart the Tweaker.")
        RegKey.SetValue(Of String)(RegKey.GUIPlatform, "Simple")
